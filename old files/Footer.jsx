...
const Footer = () => {
  return (
    <Box style={{ justifyContent: "center" }}>
      ...
      >
        More about the WalletWatch
      </h1>
      <FooterContainer>
        <Row>
          <Column>
            <Heading>Find us on github!</Heading>
            <FooterLink href="https://github.com/nsettyy">Nick</FooterLink>
            <FooterLink href="https://github.com/TorresBones">
              Jonathan
            </FooterLink>
            <FooterLink href="https://github.com/BorzoiBurrow">Brad</FooterLink>
            <FooterLink href="https://github.com/savannahjk02">
              Savannah
            </FooterLink>
            <FooterLink href="https://github.com/nguyent0275">Toan</FooterLink>
